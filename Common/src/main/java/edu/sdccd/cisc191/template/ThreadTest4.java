...
public class ThreadTest4 {
    ...
    /**
     * Counts the primes in the range from (START+1) to (2*START), using an
     ExecutorService
     * thread pool.  The total elapsed time is printed.  The computation is broken
     up
     * into numberOfTasks subtasks, each represented by an object of type
     CountPrimesTask.
    ...
    /**
     * Gets the number of tasks from the user and counts primes using that many
     tasks.
     */
    public static void main(String[] args) {
        ...
        if (processors == 1)
            ...
            System.out.println("Your computer has " + processors + " available processors.\n");
                    System.out.println("This program breaks up the computation into a number oftasks.");
